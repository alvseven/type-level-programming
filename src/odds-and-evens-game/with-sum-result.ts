...
type IsNegativeNumber<T extends number> = `${T}` extends `-${T}` ? true : false;
...
/*
 Points for improvement:
  ...
  - Line 55 is somewhat unnecessary, TypeScript doesn’t recognize that Sum<> returns a number,
  ...
  - Line 60 has the same issue as line 55, with the added inefficiency of recomputing the Sum type three times.
